...
install:
	python -m pip install -e packages/contracts -e packages/sdk -e services/controller -e services/worker -e plugins/builtin -e plugins/genchi -e services/normalizer -e dashboard -e '.[dev]'
