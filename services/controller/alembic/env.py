...
schema = os.environ.get("ALLFEEDS_DB_SCHEMA", "allfeeds")
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        ...
        # SQLAlchemy 2 starts an implicit transaction for SET. Commit it so
        # Alembic owns and commits the migration transaction that follows.
        connection.commit()
