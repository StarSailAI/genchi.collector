...
4. [批量 AI 审核](../guides/batch-review.md)对所有来源的候选作独立二次核对。官方正文、票务平台的原生场次，以及有可追溯活动链接的编辑来源在通过各自证据门槛后自动发布；明确不属于收录范围的候选可退出队列。证据不足或有冲突的候选仍由管理员在 `/zh-Hans/admin` 核对、修订或拒绝。原文已更新的旧候选不能发布。
