...
Detailed coding and operational constraints for this repository. Start with
[AGENTS.md](../../AGENTS.md), then read this reference before changing code.
For environment setup and release commands, use [development setup](getting-started.md).
...
Use [development setup](getting-started.md) for installation, all validation
commands and the complete list of distributable packages. Follow the documentation
ownership rules in [AGENTS.md](../../AGENTS.md) and add new guides to the
[documentation index](../README.md). Live crawling and upstream acceptance run on
the deployed server only; keep local collection services stopped.
...
7. Local documentation links and release hygiene checks pass.
8. User-facing docs are updated without turning the README into a developer
   manual.

## Product v2 invariants

- Read `docs/architecture/product-v2.md` for the current domain and deployment model.
...
- Read `docs/guides/naming.md` before changing glossary or title handling. Coordinate any changed schema contract with the website; 1.3 introduced naming tables.
...
- User-system configuration and acceptance: docs/guides/accounts.md, docs/architecture/foundation-decisions.md, docs/archive/foundation/acceptance.md.
